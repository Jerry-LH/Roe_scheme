module global
  ...
  real::x(0:200),t=0,dt=1e-5,gama=1.4,U(0:201,3),F(0:201,3),lamda(3),dx,&
        u_a,h_a,c_a,k(3,3),F_half(0:201,3),U00(0:201,3),U01(0:201,3),U02(0:201,3),alpha(3)                    
end module
...
subroutine flux
  use global
  real::rl,rr,ul,ur,el,er,pl,pr,hl,hr
  do j=0,x_step
    ...
    pl=(gama-1)*(rl*el-0.5*rl*ul**2)
    pr=(gama-1)*(rr*er-0.5*rr*ur**2)
    hl=el+pl/rl
    hr=er+pr/rr
